...
public class Event {
    ...
    private Categorie categorie; // Assurez-vous que ce champ est présent
    ...
    public Event(int id, String nom, String description, String emplacement, int nombrePlaces, LocalDate date) {
        this(id, nom, description, emplacement, nombrePlaces, date, null); // Appel au constructeur avec catégorie
    }
